...
<FeatureList
    items={[
        ...
        { title: "Product strategy", body: "Business models (ad-driven, subscription, open source) influence how much content is produced, consumed, and stored — shaping third-order impacts." }
    ]}
/>
