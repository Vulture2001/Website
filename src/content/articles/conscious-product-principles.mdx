...
<FeatureList
    items={[
        { title: "Transparency", body: "Make data flows, algorithms, and decision logic visible. Users should know why they see certain content, how their data is used, and what trade-offs exist." },
