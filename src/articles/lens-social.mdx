...
<Table
    ...
    rows={[
        ...
        [
            ...
            "Algorithmic ranking that shapes what articles users see; visibility of some groups over others; harassment in comment sections."
        ],
        [
            "Third order",
...
<Table
    ...
    rows={[
        [
            ...
            "Encourage more inclusive articles creation and consumption.",
            "Normalize captioning as an expectation across digital platforms."
        ],
        [
            "Algorithmic feed",
            "Determines what articles a user sees immediately.",
