...
⚠️ **Why we focus on environmental and social dimensions here:**
While all five dimensions are important, my thesis (and this educational website) places particular emphasis on *environmental* and *social* sustainability. These are the areas where current software practice shows the largest gaps: ecological reasoning is underdeveloped, and social equity and inclusivity remain inconsistently addressed. By focusing on these two dimensions, we can tackle the most pressing challenges first — while keeping the broader framework in mind.
